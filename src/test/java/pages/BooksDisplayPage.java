...
public class BooksDisplayPage extends BasePage{
    ...
    public By discount_tag1 = By.xpath("//p[normalize-space()='66']");
    ...
    public By hover_book5_text = By.xpath("/html[1]/body[1]/div[8]/section[3]/section[1]/div[1]/div[1]/div[1]/div[5]/a[1]/div[1]/div[1]/button[1]");
    ...
    public By book_items_5 = By.xpath("//img[@alt='Jahangirnagar GK image']");
    public By book5_view_details_option = By.xpath("//a[contains(@class,'home-details-btn') and contains(@href,'/book/508419')]");
    public By book5_details = By.xpath("//div[@class='ml-2 w-100']//p[contains(text(),'বিশ্ববিদ্যালয় ভর্তি প্রস্তুতির বই ১০৯৯+৳ অর্ডারে ফ')]");
    public String book5_page_url = "https://www.rokomari.com/book/508419/jahangirnagar-gk";
    ...
    public By academic_phy_book5 = By.xpath("//div[@class='product-item slick-slide slick-active']//img[@alt='পদার্থবিজ্ঞান-২য় পত্র (একাদশ-দ্বাদশ শ্রেণি) image']");
    public By academic_phy_book5_title = By.xpath("//h1[contains(.,'পদার্থবিজ্ঞান-২য় পত্র')]");
    public By academic_phy_book5_author_name = By.xpath("//p[@class='details-book-info__content-author']//a[contains(text(),'প্রফেসর মোঃ আখতারুল ইসলাম')]");
    public By academic_phy_book5_price = By.xpath("//span[@class='sell-price'][normalize-space()='TK. 518']");
    public By academic_phy_book5_details_option = By.xpath("//a[@class='see-more-details']");
    public By academic_phy_book5_details = By.xpath("//div[@id='js--summary-description']");
