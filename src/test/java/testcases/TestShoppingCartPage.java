...
//        shoppingCartPage.waitForUpdatedAmount(shoppingCartPage.total_price);
        Assert.assertEquals(shoppingCartPage.getElementText(shoppingCartPage.total_price),"661 Tk.");
...
//        Assert.assertEquals(shoppingCartPage.getElementText(shoppingCartPage.total_price),"110 Tk.");
        ...
        shoppingCartPage.waitForUpdatedAmount(shoppingCartPage.total_price);
        Assert.assertEquals(shoppingCartPage.getElementText(shoppingCartPage.total_price),"771 Tk.");
