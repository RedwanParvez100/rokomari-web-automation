...
//
//        checkoutPage.scrollAndHover(checkoutPage.page3_2nd_row_5th_book);
//        Thread.sleep(3000);
//        checkoutPage.clickOnElement(checkoutPage.book5_add_cart);
...
//        checkoutPage.clickOnElement(checkoutPage.user_name_field);
...
//        Assert.assertTrue(checkoutPage.isEnable(checkoutPage.address_field));
    }
...
//        Thread.sleep(3000);
//        Assert.assertTrue(checkoutPage.isSelected(checkoutPage.payment_option1));
